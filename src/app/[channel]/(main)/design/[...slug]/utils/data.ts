...
const getMetaDtataFromColorVariant = (colorId: string, listColorVariant: Map<string, object>) => {
  ...
  if (colorVariant && (colorVariant as any).meta_data) {
    ...
    console.error(`Không tìm thấy dữ liệu cho colorId: ${colorId}`);
...
export {fetchProductDetail, getMetaDtataFromColorVariant, getVariantIdFromColorVariant, uploadImage};