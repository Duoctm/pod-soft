                  ...
                  <Box
                    ...
                    onClick={() => {
                      if (designerRef.current) {
                        ...
                        // console.log('truoc')
                        // var index = 0;
                        // for (const item in designerRef.current.stages){
                        //   index++;
                        //   console.log(index, designerRef.current.stages[item].stage?.width(), designerRef.current.stages[item].stage?.height())
                        // }
                        // for(const item in data){
                        //   const imageDom = document.getElementById(data[item].code+ "Image") as HTMLImageElement;
                        //   designerRef.current.updateStagePosition(designerRef.current.stages[item], data[item], imageDom);
                        // }
                        ...
                        for(const item in result){
                          ...
                          if (thumbnailDom) {
                            thumbnailDom.setAttribute('src', result[item].image); // hoặc URL mới tùy bạn
                          }
                        }
