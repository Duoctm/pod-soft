...
// import {fetchProductDetail, getMetaDtataFromColorVariant, getVariantIdFromColorVariant, updateCheckoutLineMetadata} from '../utils/data'
// import addItem from '../utils/checkout'
...
//                     const cartItem =  JSON.parse(json);
//                     if (designerRef.current != null){
//                       const newCartItemId = await addItem(cartItem.params, cartItem.selectedVariantId, cartItem.quantity )
//                       console.log(newCartItemId);
//                       const metaData = await designerRef.current.exportDesignToJson();
//                       const result = await updateCheckoutLineMetadata(newCartItemId, [{
//                         key: "design",
//                         value: metaData,
//                       }]);
