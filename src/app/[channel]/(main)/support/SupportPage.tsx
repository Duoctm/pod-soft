...
var initialValues: SupportFormData = {
    firstName: "",
    lastName: "",
    email: "",
    phoneNumber: "",
...
const getUserAndSetToForm = async () => {
    ...
    initialValues.phoneNumber = user?.addresses[0].phone || "";
    initialValues.address = `${user?.addresses[0].streetAddress1}, ${user?.addresses[0].city}, ${user?.addresses[0].country.country}`
    initialValues.details = `Please grant me permission to place orders under 500`
}
