	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center bg-white">
						...
						<g className="full-torradeira">
							...
							<g className="t-shirt">
								...
								<g transform="translate(-448 -158) translate(448 157) translate(340.903 168.466)">
									...
									/>
									{/* T-shirt collar */}
									<path fill="#1565C0" d="M20 0 L45 0 L40 10 L25 10 Z" mask="url(#prefix__r)" />
								</g>
							</g>
							<g className="shirt-front">
								{/* Main shirt body */}
								...
								<g transform="translate(-448 -158) translate(448 157) translate(344.301 197.242)">
									<circle className="button-left" fill="#FFF" cx="4" cy="4" r="4" />
								</g>

								{/* Right button */}
								<g transform="translate(-448 -158) translate(448 157) translate(361.087 197.242)">
									<circle className="button-right" fill="#FFF" cx="4" cy="4" r="4" />
								</g>

								{/* Shirt pocket */}
								<g transform="translate(-448 -158) translate(448 157) translate(350.495 206.834)">
									<path className="pocket" fill="#FD8C6E" d="M-3 0 L13 0 L13 15 L-3 15 Z" />
								</g>
							</g>
							<g
								className="box"
							...
							>
								...
								<path
									...
									strokeWidth="1"
									strokeDasharray="2,2"
									d="M0 10 L74 10 M0 25 L74 25 M0 40 L74 40"
									mask="url(#prefix__x)"
								/>
								<path
									fill="none"
									stroke="#BFA17F"
									strokeWidth="2"
									d="M15 0 L15 57 M60 0 L60 57"
									mask="url(#prefix__x)"
								/>
								{/* Add cardboard flaps */}
								<path fill="#C19A6B" d="M-5 -5 L15 5 L60 5 L80 -5 L-5 -5" mask="url(#prefix__x)" />
							</g>
						</g>
			...
			<div className="flex flex-col">
				<h1 className="mb-4 w-full max-w-[529px] text-4xl font-bold text-[#4b4b62]">
					Woops! <br />
				...
				<button
					className="mt-8 h-10 rounded-md bg-[#8C3859] px-6 font-semibold text-white"
					onClick={() => reset()}
				>
					Try again
				</button>
