...
const OurStory = () => {
    return (
        <Wrapper className='flex flex-col items-center justify-center max-w-full px-0 min-h-[calc(100vh-100px)] lg:min-h-[calc(100vh-142px)]  relative overflow-hidden'>
            <div className='relative w-full  flex flex-1 flex-col z-20  text-white text-center py-20 lg:py-32 px-4 lg:px-0 items-center justify-center lg:justify-start'>
                <Wrapper className='w-full flex items-start '>
                    <div className='flex flex-col items-start justify-center gap-4 lg:gap-6 flex-1 max-w-3xl w-full'>
                        <h2 className="text-4xl md:text-6xl lg:text-[65px] font-bold text-white text-start">
                            OUR STORY
                        </h2>
                        <ul className='style-none list-disc text-left text-lg md:text-2xl lg:text-3xl font-semibold lg:mt-10 space-y-4'>
            ...
            <Image src={'/images/our-story.webp'} alt='Hero Image' fill className='
