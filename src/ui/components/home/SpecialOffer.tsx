...
export default function SpecialOffer() {
	return (
		<div className="w-full bg-[#263246] py-6 md:py-14 ">
			<Wrapper className="flex flex-col items-center justify-center px-4 sm:px-0">
				<h3 className="px-2 md:px-0 captitalize w-full max-w-[877px] text-center text-[32px] font-bold  text-white sm:text-[32px] leading-[38px] md:leading-[71.25px] md:text-5xl lg:text-[56px]">
