...
export class RegisterPage {
	constructor(page) {
		...
		this.emailVerificationNeededMessage = page.locator(
	...
	async getEmailVerificationNeededMessageElement() {
		return this.emailVerificationNeededMessage;
	}
	async getEmailExistsErrorElement() {
		return this.emailExistsErrorMessage;
	}
	async getPasswordMismatchErrorElement() {
		return this.passwordMismatchErrorMessage;
	}

	// Methods to get required field error message elements
	async getFirstNameRequiredErrorElement() {
		return this.firstNameRequiredError;
	}
	async getLastNameRequiredErrorElement() {
		return this.lastNameRequiredError;
	}
	async getEmailRequiredErrorElement() {
		return this.emailRequiredError;
	}
	async getPasswordRequiredErrorElement() {
		return this.passwordRequiredError;
	} // Will return the locator for "Password is required"
	async getConfirmPasswordRequiredErrorElement() {
		return this.confirmPasswordRequiredError;
	}
}
