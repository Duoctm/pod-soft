...
test.describe("PS001 - Home Page Performance Tests", () => {
	...
	test("should pass PageSpeed Insights test for desktop", async () => {
		...
		console.log(
			...
			result.data.lighthouseResult.categories["best-practices"].score,
		);
...
test.describe("PS002 - Service Page Performance Tests", () => {
	...
	test("should pass PageSpeed Insights test for desktop", async () => {
		...
		// Save detailed results
		console.log(
			"Service Page - Desktop Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Service Page - Desktop Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Service Page - Desktop Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
	...
	test("should pass PageSpeed Insights test for mobile", async () => {
		...
		// Save detailed results
		console.log(
			"Service Page - Mobile Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Service Page - Mobile Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Service Page - Mobile Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
...
test.describe("PS003 - Products Page Performance Tests", () => {
	...
	test("should pass PageSpeed Insights test for desktop", async () => {
		...
		// Save detailed results
		console.log(
			"Products Page - Desktop Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Products Page - Desktop Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Products Page - Desktop Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
	...
	test("should pass PageSpeed Insights test for mobile", async () => {
		...
		// Save detailed results
		console.log(
			"Products Page - Mobile Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Products Page - Mobile Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Products Page - Mobile Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
...
test.describe("PS004 - Support Page Performance Tests", () => {
	...
	test("should pass PageSpeed Insights test for desktop", async () => {
		...
		// Save detailed results
		console.log(
			"Support Page - Desktop Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Support Page - Desktop Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Support Page - Desktop Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
	...
	test("should pass PageSpeed Insights test for mobile", async () => {
		...
		// Save detailed results
		console.log(
			"Support Page - Mobile Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Support Page - Mobile Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Support Page - Mobile Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
...
test.describe("PS005 - Login Page Performance Tests", () => {
	...
	test("should pass PageSpeed Insights test for desktop", async () => {
		...
		// Save detailed results
		console.log(
			"Login Page - Desktop Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Login Page - Desktop Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Login Page - Desktop Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
	...
	test("should pass PageSpeed Insights test for mobile", async () => {
		...
		// Save detailed results
		console.log(
			"Login Page - Mobile Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Login Page - Mobile Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Login Page - Mobile Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
...
test.describe("PS006 - Authenticated Product Detail Page Performance Tests", () => {
	test.beforeEach(async ({ page }) => {
		...
		await expect(page.getByRole("heading", { name: /Welcome to ZoomPrints/i })).toBeVisible({
			timeout: 60000,
		});
	...
	test("should pass PageSpeed Insights test for authenticated product detail page (desktop)", async ({
		page,
	}) => {
		...
		const result = await psi(
			`${PRODUCTS_URL}/bella-3001`,
			{
				key: process.env.PAGESPEED_API_KEY,
				strategy: "desktop",
				category: ["performance", "accessibility", "best-practices", "seo"],
		...
		console.log(
			"Authenticated Product Detail Page - Desktop Performance Score:",
			result.data.lighthouseResult.categories.performance.score,
		);
		console.log(
			"Authenticated Product Detail Page - Desktop Accessibility Score:",
			result.data.lighthouseResult.categories.accessibility.score,
		);
		console.log(
			"Authenticated Product Detail Page - Desktop Best Practices Score:",
			result.data.lighthouseResult.categories["best-practices"].score,
		);
		console.log(
			"Authenticated Product Detail Page - Desktop SEO Score:",
			result.data.lighthouseResult.categories.seo.score,
		);
	}, 120000);
});
