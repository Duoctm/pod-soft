...
import { LOGIN_URL, PRODUCTS_URL, CART_URL } from "./utils/constants.js";
import { CartPage } from "./pageObjects/ShoppingCartPage.js";
...
test.describe("Shopping Cart Tests", () => {
	test("CT001 - Add Product to Cart", async ({ page }) => {
		...
		await page.waitForSelector("text=Added to Cart", { timeout: 15000 });
